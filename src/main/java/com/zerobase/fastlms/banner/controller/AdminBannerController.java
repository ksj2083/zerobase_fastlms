...
//        System.out.println("------------------------------------------");
//        System.out.println(bannerList.get(0).getName());
//        System.out.println(bannerList.get(0).getRegDt());
//        System.out.println(bannerList.get(0).getTotalCount());
    ...
    public String addSubmit(Model model, HttpServletRequest request
        ...
        if (file != null) {
            ...
            String baseLocalPath = "C:/zerobase study/java/spring/학습관리시스템_프로젝트_시작소스_fastlms3/fastlms3/files";
